...
CHECK_OPTIONAL_VARIABLE_NOPATH(GIT_WATCHER_TARGET_NAME "check_git")
...
function(GetGitState _working_dir)
    ...
    if(NOT exit_code EQUAL 0)
        ...
        set(ENV{CB_MODULES_GIT_DESCRIBE} "unknown")
    else()
        set(ENV{GIT_DESCRIBE} "${output}")
        set(ENV{CB_MODULES_GIT_DESCRIBE} "${output}")
    endif()
    ...
    string(REGEX MATCH "([0-9])+\\.([0-9]+)\\.([0-9]+)" _ "$ENV{GIT_DESCRIBE}")
